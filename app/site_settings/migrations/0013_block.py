...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('site_settings', '0012_column_delete_block'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_title', models.BooleanField(default=True, verbose_name=':wЗаголовок')),
                ...
                ('column', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='site_settings.column', verbose_name='Позиция')),
            ],
            options={
                'verbose_name': 'Блок',
