...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('grid', '0039_delete_modulecontent'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='menus.menu', verbose_name='Меню')),
